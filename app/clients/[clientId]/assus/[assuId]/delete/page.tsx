...
const ClientAssuDeletePage = ({ params }: ClientAssuUpdatePageProps) => {
    ...
    <div className="w-full mx-auto ">
      ...
      >
        <div className="bg-black-400 text-center text-red-400 text-xl py-2">
          {"Etes-vous sûr de vouloir supprimer ce dossier d'assurance ?"}
        </div>
...
export default ClientAssuDeletePage;
