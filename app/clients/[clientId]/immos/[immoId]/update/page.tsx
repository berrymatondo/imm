...
const ClientImmoUpdatePage = ({ params }: ClientAssuUpdatePageProps) => {
    ...
    <div className="w-full mx-auto ">
      <div className=" rounded-lg p-2 mt-2 bg-primary">
        ...
        <div className="flex justify-between items-center">
          <p className="text-sm">
            {
              "Cette transaction permet de modifier un nouveau dossier immobilier d'un client"
            }
          </p>
        </div>
      </div>
...
export default ClientImmoUpdatePage;
